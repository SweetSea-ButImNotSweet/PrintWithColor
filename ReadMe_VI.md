...
### Các đối số trong lệnh print() **của PrintWithColor**
...
# Có câu hỏi? Cần trợ giúp?
Cứ gặp mình tại trang [Issues](https://github.com/SweetSea-ButNotSweet/PrintWithColor/issues)<br>
Chuyện khác? [Gặp mình tại nơi này](https://github.com/SweetSea-ButNotSweet/SweetSea-ButNotSweet/issues)